...
configFilePath = os.path.join(os.path.abspath(os.path.join(__file__, os.pardir, os.pardir)), 'config', r'scraper_config.txt')
# configFilePath = path.join(path.dirname(__file__), r'scraper_config.txt')
...
with TelegramClient('name', api_id, api_hash) as client:
    ...
    async def main():
        ...
        for chat_id in chat_ids:
            ...
            try:
                if last_analyzed_id < (id_cutoff := await get_last_message(chat_id) - 2):  # should be 5000 or last_analyzed_id == 0
